			...
			<div class="row">
				<div class="col-sm-4">
					<div class="logo pull-left">
						<a href="{{URL::to('/trang-chu')}}"><img src="{{URL::to('/public/frontend/images/logo.png')}}" style="width:120px;height:50px;" alt="" /></a>
					</div>
				</div>
				<div class="col-sm-8">
				...
				<div class="col-sm-8">
					...
					<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Chính sách<i class="fa fa-angle-down"></i></a>
								...
								<li class="dropdown"><a href="contact-us.html">Liên hệ<i class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
